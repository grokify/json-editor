...
JSONEditor.defaults.editors.string = JSONEditor.AbstractEditor.extend({
  ...
  build: function() {
    ...
    //if(this.schema.description) this.description = this.theme.getFormInputDescription(this.schema.description); // JCW EDIT TOOLTIPSTER
...
JSONEditor.defaults.editors.select = JSONEditor.AbstractEditor.extend({
  ...
  build: function() {
    var self = this;
    if(!this.options.compact) this.header = this.label = this.theme.getFormInputLabel(this.getTitle());
    //if(this.schema.description) this.description = this.theme.getFormInputDescription(this.schema.description); // TOOLTIPSTER
...
JSONEditor.AbstractTheme = Class.extend({
  ...
  getFormInputLabel: function(text) {
    ...
    el.className = el.className + " jbeFormInputLabel";
    el.appendChild(document.createTextNode(text));
    return el;
  },
